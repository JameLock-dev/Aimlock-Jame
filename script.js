...
// KHÔNG thêm /admin.html
// KHÔNG thêm dấu / cuối link
// Link API đúng sẽ là: https://aimlock-jame-production.up.railway.app/api/verify-key
...
async function apiFetch(path, options = {}) {
  ...
  try {
    ...
    throw new Error(
      "Không kết nối được API Railway. Hãy kiểm tra API_BASE hoặc domain backend."
    );
  }
  ...
  try {
    ...
    throw new Error(
      "API đang trả về HTML, không phải JSON. Kiểm tra lại API_BASE, không được thêm /admin.html."
    );
  }
